		...
		<Screen variant="warm">
			...
			<View className="flex-1 items-center justify-center px-2 gap-8">
				...
				<View className="gap-2 items-center">
					<Text className="text-gray900 text-[24px] font-hahmlet-bold text-center leading-[30px]">
						주변 전시를{'\n'}바로 찾을 수 있어요
					</Text>
				...
				>
					<View className="px-5 py-8 items-center gap-0.5">
						<Text className="text-gray900 text-[15px] font-pretendard-semibold">
							위치 접근 허용
						</Text>
					...
					<View className="py-3.5 items-center border-b border-black/[0.07]">
						<Text className="text-gray900 text-[15px] font-pretendard-regular">한 번 허용</Text>
					</View>
					<View className="py-3.5 items-center">
						<Text className="text-gray900/40 text-[15px] font-pretendard-regular">허용 안 함</Text>
					</View>
				</View>
			</View>
			...
			<Screen.Bottom className="pb-10 gap-3">
				<Pressable
					className="w-full bg-secondary items-center justify-center rounded-[18px] py-[18px] border-[0.5px] border-white/25"
					style={({ pressed }) => ({ opacity: pressed ? 0.85 : 1 })}
					onPress={handleAllow}
					accessibilityRole="button"
					accessibilityLabel="위치 허용하기"
				>
					<Text className="text-[16px] text-white font-pretendard-semibold">허용하기</Text>
				</Pressable>
				<Pressable
				...
				>
					<Text className="text-[14px] text-secondary font-pretendard-regular">
						나중에 설정할게요
					</Text>
				</Pressable>
			</Screen.Bottom>
