    ...
    <Screen variant='warm'>
      ...
      >
        ...
        >
          ...
          {selectedOption?.tip ? (
            <View className='flex-row gap-2 rounded-2xl bg-[#EFF6FF] px-4 py-3.5 mb-3'>
              <Ionicons name='bulb-outline' size={16} color='#3B82F6' style={{ marginTop: 1 }} />
          ...
          {reason === 'other' ? (
            <TextInput
              ...
              style={{ fontFamily: 'Pretendard-Regular', minHeight: 120, textAlignVertical: 'top' }}
