			...
			<Screen variant='warm'>
				...
				<View className='flex-1 px-6 pt-10'>
					...
					<Pressable
						...
						className='rounded-3xl bg-[#F2EFE9] items-center justify-center min-h-[52px]'
		...
		<Screen variant='warm'>
			...
			<View className='pt-6'>
				{user.email && (
					...
					>
						<View className='flex-row items-center justify-between px-4 border-b border-black/5 min-h-[52px]'>
				...
				<Pressable
					...
					disabled={signingOut}
					className='rounded-3xl bg-[#F2EFE9] flex-row items-center justify-center gap-2 min-h-[52px]'
					...
					<View className='w-full rounded-3xl bg-white p-6'>
						...
						<View className='flex-row gap-2'>
							...
							<Pressable
								...
								className='flex-1 rounded-2xl bg-red-500 items-center justify-center py-[14px]'
