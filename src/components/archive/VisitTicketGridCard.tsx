...
export function VisitTicketGridCard({ dateKey, title, venue, onPress }: VisitTicketGridCardProps) {
			...
			{({ pressed }) => (
				...
				>
					...
					>
						...
						{/* 텍스트 정보 */}
						<View className="justify-between p-4 w-full" style={{ height: CARD_HEIGHT }}>
							<View>
								<Text
									numberOfLines={2}
							...
							<View className="flex-row items-center justify-between">
								...
								<View className="items-end pt-px pl-4 pr-[11px]">
									<MiniBarcode dateKey={dateKey} color="rgba(61,43,26,0.25)" length={40} />
								</View>
							</View>
						</View>
					</View>
