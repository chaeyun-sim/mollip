...
function buildTimeline(route: RouteResult, destinationLabel: string): TimelineItem[] {
  ...
  items.push({ type: 'endpoint', key: 'end', variant: 'end', label: destinationLabel });
  return items;
}
        ...
        return (
          <Pressable
            ...
            className={cn(
              ...
              active ? 'bg-[#1C1917] border-transparent' : 'bg-transparent border-black/10',
            )}
            hitSlop={4}
            accessibilityRole='button'
            accessibilityState={{ selected: active }}
